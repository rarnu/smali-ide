...
const
  RESERVED_WORDS_TP: array [1..58] of String = (
    'absolute', 'and', 'array', 'asm',
    'begin',
    'case', 'const', 'constructor',
    'destructor', 'div', 'do', 'downto',
    'else', 'end', 'exit',
    'file', 'for', 'function', 'false',
    'goto',
    ...
    'record', 'reintroduce', 'repeat', 'return',
  ...
  RESERVED_WORDS_FPC: array [1..2] of String = (
    'dispose', 'new'
  );
