{
   ...
   fpmake.pp for bs_SynEdit 5.5.1

   This file was generated on 26/7/2015
}
...
procedure add_bs_SynEdit(const ADirectory: string);
...
begin
  with Installer do
    ...
    P.InstallFiles.Add('bs_SynEdit.compiled',AllOSes,'$(unitinstalldir)');
